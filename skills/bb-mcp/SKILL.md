---
name: bb-mcp
description: Dados bancários do Banco do Brasil via Open Finance Brasil: saldos, extratos, faturas de cartão, investimentos e empréstimos. Use quando o usuário perguntar sobre dinheiro/conta/cartão/investimentos do Banco do Brasil.
---

# Banco do Brasil MCP — REST API skill

Você tem acesso à **Banco do Brasil MCP** REST API na MCP.AI.
...
Este MCP também funciona via **conexão MCP** (Claude / Cursor) em `https://api.mcp.ai/p_bb` — veja o [README](../../README.md). A skill acima é pra consumir a **REST API** direto (agente próprio / código).
